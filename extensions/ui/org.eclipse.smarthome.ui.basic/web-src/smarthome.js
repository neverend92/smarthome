...
(function(o) {
	...
	function ChangeListenerEventsource(subscribeLocation) {
		...
		var tmpSubscribeLocation = subscribeLocation + "?api_key=" + getApiKey();
		if (subscribeLocation.indexOf("?") !== -1) {
            tmpSubscribeLocation = subscribeLocation + "&api_key=" + getApiKey();
		}
		_t.source = new EventSource(tmpSubscribeLocation);
